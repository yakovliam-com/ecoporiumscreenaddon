...
import com.yakovliam.ecoporium.api.model.manager.Manager;
import com.yakovliam.ecoporiumscreenaddon.EcoporiumScreenAddonPlugin;
import com.yakovliam.ecoporiumscreenaddon.screen.loader.TrendScreenLoader;
...
public class TrendScreenManager implements Manager {
     ...
     * @param plugin plugin
     */
    public TrendScreenManager(EcoporiumScreenAddonPlugin plugin) {
