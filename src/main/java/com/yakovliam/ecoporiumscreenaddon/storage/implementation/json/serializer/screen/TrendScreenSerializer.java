package com.yakovliam.ecoporiumscreenaddon.storage.implementation.json.serializer.screen;
...
public class TrendScreenSerializer implements TypeSerializer<TrendScreen> {
     ...
     * @return instance
     */
    public static TrendScreenSerializer getInstance(EcoporiumScreenAddonPlugin context) {
        if (instance == null) {
     ...
     * @param plugin plugin
     */
    public TrendScreenSerializer(EcoporiumScreenAddonPlugin plugin) {
        this.plugin = plugin;
    }
